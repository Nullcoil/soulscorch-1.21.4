...
public class RestlessModel extends EntityModel<RestlessRenderState> {
    public static final EntityModelLayer RESTLESS = new EntityModelLayer(
            Identifier.of(Soulscorch.MOD_ID, "restless"), "main"
    );
    public static final ModelTransformer BABY_TRANSFORMER = new BabyModelTransformer(
            true, 8.0F, 6.0F, 1.9F, 2.0F, 24.0F, Set.of("head")
    );
    ...
    private static ModelData getModelData() {
        ...
        modelPartData3.addChild(
                ...
                ModelTransform.of(-6.0F, -2.0F, -3.0F, 0.0F, 0.0F, -0.6981317F)
        );
        modelPartData3.addChild(
                "left_ear",
    ...
    public void setAngles(RestlessRenderState restlessRenderState) {
        ...
        this.head.pitch = MathHelper.lerp(h, HEAD_PITCH_START, HEAD_PITCH_END);
    ...
    // Method for feature renderer to access mane parts
    public java.util.List<ModelPart> getMane(RestlessRenderState state) {
        return java.util.List.of(this.mane);
    }
